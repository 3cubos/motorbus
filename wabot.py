...
class WABot():    
    def __init__(self, json):
        ...
        self.APIUrl = 'https://eu75.chat-api.com/instance113142/'
        self.token = '0iyln1rpgj4al3wb'
    ...
    def welcome(self,chatID, noWelcome = True):
        welcome_string = ''
        if (noWelcome == False):
        ...
        if self.dict_messages != []:
            for message in self.dict_messages:
                ...
                if not message['fromMe']:                    
                    ...
                    elif text[0].lower() == 'hora':
                        return self.daet2(id, "Jumento Burro!!!")
